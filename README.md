...
- [Listopia](http://listopia-dhv.pages.dev) -  Open-source app for AI-powered collaborative list management with natural language controls and multi-channel publishing (MCP) ([Source Code](https://github.com/spaquet/listopia)) `AGPL` `Rails` `Postgres` `Tailwind`
